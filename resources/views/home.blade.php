...
<body>
	<div class="container" style="padding-top: 50px;">
		...
		<div class="form-group row">
			...
			<small id="emailHelp" class="form-text text-muted">Name should contain only characters and max size 50</small>
		</div>
		<div class="form-group row ">
			<label>Enter Pin Code:</label>
			<input type="text" class="form-control" name="pincode" maxlength="6" required="">
			<small id="emailHelp" class="form-text text-muted">Pincode must contain 6 digits of only numbers</small>
		</div>
